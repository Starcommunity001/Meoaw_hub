...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Meoaw Hub BF Premium') then
        makefolder('Meoaw Hub BF Premium')
    end
    if not _G.Dis and not isfile('Meoaw BF Premium/'..Name..'.json') then
        writefile('Meoaw Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Meoaw Hub BF Premium') and isfile 'Meoaw Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Meoaw Hub BF Premium/'..Name..'.json'))
